  ...
  return (
    <div className="flex gap-3 justify-start items-start">
      <Avatar className="h-8 w-8">
        <AvatarImage src="/lovable-uploads/5a98f7eb-ddf1-4112-bf1d-6cda3f363b1e.png" alt="PC봇" />
        <AvatarFallback className="bg-teal-600 text-white flex items-center justify-center">
