...
import { sampleData } from '../../modules/responseModules/buildRecommendationModule';
...
const ResponseRenderer: React.FC<ResponseRendererProps> = ({ content, chatMode, isCompatibilityRequest }) => {
  ...
  switch (chatMode) {
    ...
    case '견적 추천':
      return <BuildRecommendationRenderer content={content} recommendationData={sampleData} />;
    case '스펙 업그레이드':
